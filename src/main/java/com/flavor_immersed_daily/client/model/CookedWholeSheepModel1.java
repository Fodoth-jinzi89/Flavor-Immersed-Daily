...
public class CookedWholeSheepModel1 extends CookedWholeSheepModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(FlavorImmersedDaily.MODID, "cooked_whole_sheep_1"), "main");

    public CookedWholeSheepModel1(ModelPart root) {
        super(root, true);
    }
