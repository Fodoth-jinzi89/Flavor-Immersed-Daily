...
public class CookedWholeSheepModel6 extends CookedWholeSheepModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(FlavorImmersedDaily.MODID, "cooked_whole_sheep_6"), "main");

    public CookedWholeSheepModel6(ModelPart root) {
        super(root, true);
    }
    ...
    public static LayerDefinition createBodyLayer() {
		...
		.texOffs(58, 17).addBox(15.125F, -1.7576F, -5.8257F, 5.0F, 4.0F, 12.0F, new CubeDeformation(0.0F))
		.texOffs(58, 17).addBox(1.625F, -1.7576F, -5.8257F, 9.5F, 4.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.625F, 4.75F, 8.0F));
