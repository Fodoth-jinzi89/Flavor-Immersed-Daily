...
public class CookedWholeSheepModel0 extends CookedWholeSheepModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(FlavorImmersedDaily.MODID, "cooked_whole_sheep_0"), "main");

    public CookedWholeSheepModel0(ModelPart root) {
        super(root, true);
    }
    ...
    public static LayerDefinition createBodyLayer() {
		...
		.texOffs(58, 17).addBox(1.625F, -1.7576F, -5.8257F, 23.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.625F, 4.75F, 8.0F));

		PartDefinition leg3 = sheep.addOrReplaceChild("leg3", CubeListBuilder.create(), PartPose.offset(6.625F, 9.2424F, -12.8257F));

		PartDefinition leg4_r1 = leg3.addOrReplaceChild("leg4_r1", CubeListBuilder.create().texOffs(41, 17).mirror().addBox(-12.8211F, -1.25F, -6.2071F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.3536F, -7.75F, 13.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition leg3_r1 = leg3.addOrReplaceChild("leg3_r1", CubeListBuilder.create().texOffs(34, 0).mirror().addBox(-7.8211F, -3.25F, -7.6642F, 7.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.3536F, -6.75F, 13.0F, 0.0F, -0.7854F, 0.0F));
		...
		PartDefinition leg4_r2 = leg2.addOrReplaceChild("leg4_r2", CubeListBuilder.create().texOffs(41, 17).mirror().addBox(-12.8211F, -1.25F, -4.7929F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.8332F, 0.25F, 9.0204F, 0.0F, -0.7854F, 0.0F));

		PartDefinition leg3_r2 = leg2.addOrReplaceChild("leg3_r2", CubeListBuilder.create().texOffs(34, 0).mirror().addBox(-7.8211F, -3.25F, -6.25F, 7.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(1.8332F, 1.25F, 9.0204F, 0.0F, -0.7854F, 0.0F));
		...
		PartDefinition leg4_r3 = leg4.addOrReplaceChild("leg4_r3", CubeListBuilder.create().texOffs(41, 17).mirror().addBox(-11.4069F, -1.25F, -7.6213F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.8332F, 0.25F, 9.0204F, 0.0F, -0.7854F, 0.0F));

		PartDefinition leg3_r3 = leg4.addOrReplaceChild("leg3_r3", CubeListBuilder.create().texOffs(34, 0).mirror().addBox(-6.4069F, -3.25F, -9.0784F, 7.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(1.8332F, 1.25F, 9.0204F, 0.0F, -0.7854F, 0.0F));
		...
		PartDefinition leg4_r4 = leg5.addOrReplaceChild("leg4_r4", CubeListBuilder.create().texOffs(41, 17).mirror().addBox(-11.4069F, -1.25F, -3.3787F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.8332F, 0.25F, 9.0204F, 0.0F, -0.7854F, 0.0F));

		PartDefinition leg3_r4 = leg5.addOrReplaceChild("leg3_r4", CubeListBuilder.create().texOffs(34, 0).mirror().addBox(-6.4069F, -3.25F, -4.8358F, 7.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(1.8332F, 1.25F, 9.0204F, 0.0F, -0.7854F, 0.0F));
