...
// ========== ����ģʽ��ǩҳ ==========
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> AGRICULTURE_TAB = REGISTRY.register("agriculture", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(REDREPPER.get()); output.accept(SACLLION.get()); output.accept(SPINACH.get());
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> FOOD_TAB = REGISTRY.register("food", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                // �򵥲�??
                output.accept(BAKEDWHITEMUSHROOMSWITHCREAM.get()); output.accept(BRAISEDBEANSPROUTSWITHVERMICELLI.get()); output.accept(CANTONESERICEROLLS.get());
                ...
                output.accept(COOKEDCHICKENBREAST.get()); output.accept(COOKEDCHICKENLEAN.get()); output.accept(COOKEDCORNBATTER.get()); output.accept(COOKEDCRISPYPORK.get());
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> INGREDIENT_TAB = REGISTRY.register("ingredient", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                // ��ζ??����
                output.accept(BROWNSUGARSYRUP.get());
