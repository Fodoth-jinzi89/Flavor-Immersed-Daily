...
public class CookedWholeSheepModel5 extends CookedWholeSheepModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(FlavorImmersedDaily.MODID, "cooked_whole_sheep_5"), "main");

    public CookedWholeSheepModel5(ModelPart root) {
        super(root, true);
    }
    ...
    public static LayerDefinition createBodyLayer() {
		...
		.texOffs(58, 17).addBox(15.125F, -1.7576F, -5.8257F, 9.5F, 4.0F, 12.0F, new CubeDeformation(0.0F))
