...
public class CookedWholeSheepModel2 extends CookedWholeSheepModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(FlavorImmersedDaily.MODID, "cooked_whole_sheep_2"), "main");

    public CookedWholeSheepModel2(ModelPart root) {
        super(root, true);
    }
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg4_r2 = leg4.addOrReplaceChild("leg4_r2", CubeListBuilder.create().texOffs(41, 17).mirror().addBox(-11.4069F, -1.25F, -7.6213F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.8332F, 0.25F, 9.0204F, 0.0F, -0.7854F, 0.0F));

		PartDefinition leg3_r2 = leg4.addOrReplaceChild("leg3_r2", CubeListBuilder.create().texOffs(34, 0).mirror().addBox(-6.4069F, -3.25F, -9.0784F, 7.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(1.8332F, 1.25F, 9.0204F, 0.0F, -0.7854F, 0.0F));
